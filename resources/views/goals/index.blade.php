...
@section('page-header')
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="/goal_type/add" class="btn add-btn"><i class="fa fa-plus"></i> Add New</a>
        </div>
    </div>
@endsection
                        ...
                        @foreach ($goals as $goal)
                            @if (!empty($goal->goal_type))
                                <tr>
                                    ...
                                    <td>
                                        <i
                                            class="fa fa-dot-circle-o @if ($goal->status == 'Active') text-success @else text-danger @endif"></i>
                                        {{ $goal->status }}
                                    </td>
                                    <td>
                                        ...
                                        <div class="progress" style="height:5px">
                                            <div class="progress-bar bg-primary progress-sm"
                                                style="width: {{ $goal->progress }}%;height:10px;"></div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a data-id="{{ $goal->id }}" data-subject="{{ $goal->subject }}"
                                                    data-type="{{ $goal->goal_type->id }}"
                                                ...
                                                <a data-id="{{ $goal->id }}" class="dropdown-item deletebtn"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon"><input name="start_date" class="form-control datetimepicker"
                                            type="text"></div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon"><input name="end_date" class="form-control datetimepicker"
                                            type="text"></div>
                                </div>
                            </div>
                    ...
                    <form method="post" action="{{ route('goal-tracking') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Start Date <span class="text-danger">*</span></label>
                                    <div class="cal-icon"><input class="form-control datetimepicker edit_start"
                                            name="start_date" type="text"></div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>End Date <span class="text-danger">*</span></label>
                                    <div class="cal-icon"><input class="form-control datetimepicker edit_end"
                                            name="end_date" type="text"></div>
                                </div>
                            </div>
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    <label for="customRange">Progress</label>
                                    <input type="range" name="progress" class="form-control-range custom-range"
                                        id="customRange">
